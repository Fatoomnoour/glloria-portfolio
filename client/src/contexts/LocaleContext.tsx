...
const copy: Record<string, { ar: string; en: string }> = {
  ...
  "booking.stepContact": { ar: "بيانات التواصل", en: "Contact details" },
  "booking.stepSpace": { ar: "المساحة", en: "The space" },
  "booking.stepScope": { ar: "الخدمة والميزانية", en: "Scope & budget" },
  "booking.stepSchedule": { ar: "الموعد والتفاصيل", en: "Timing & details" },
