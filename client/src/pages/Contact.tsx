...
import { ArrowUpLeft, Check, Instagram, MapPin, Phone } from "lucide-react";
...
export default function Contact() {
  ...
  return (
    <div className="contact-page page-transition section-pad">
      <div className="contact-top"><div className="section-marker"><span>06</span><span>LET'S TALK</span></div><p className="contact-location"><MapPin size={15} /> قنا، مصر <span>·</span> نعمل على مشاريع مختارة</p></div>
      <div className="contact-layout">
        <div className="contact-copy"><p className="eyebrow">تواصلي مع Glloria</p><h1>المكان الذي<br /><em>تتخيلينه يبدأ هنا.</em></h1><p>أرسلي لنا بعض التفاصيل عن مشروعك، وسنعود إليكِ خلال 24 ساعة لنسمع الحكاية كاملة.</p><div className="contact-details"><a href="https://wa.me/201000000000" target="_blank" rel="noreferrer"><span><Phone size={15} /> WhatsApp</span><b>+20 100 000 0000</b></a><a href="mailto:hello@glloria.studio"><span>البريد الإلكتروني</span><b>hello@glloria.studio</b></a><a href="https://www.instagram.com/glloriaaa" target="_blank" rel="noreferrer"><span><Instagram size={15} /> Instagram</span><b>@glloriaaa</b></a></div></div>
