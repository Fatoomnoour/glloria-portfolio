  ...
  return (
    <div className="contact-page page-transition section-pad">
      ...
      <div className="contact-layout">
        <div className="contact-copy"><p className="eyebrow">تواصلي مع Glloria</p><h1>المكان الذي<br /><em>تتخيلينه يبدأ هنا.</em></h1><p>أرسلي لنا بعض التفاصيل عن مشروعك، وسنعود إليكِ خلال 24 ساعة لنسمع الحكاية كاملة.</p><div className="contact-booking-link"><CalendarDays size={15} /><div><span>جاهزة للبدء؟</span><a href="/booking">احجزي استشارتك مباشرة <ArrowUpLeft size={15} /></a></div></div><div className="contact-details"><a href="https://wa.me/201000000000" target="_blank" rel="noreferrer"><span><Phone size={15} /> WhatsApp</span><b>+20 100 000 0000</b></a><a href="mailto:hello@glloria.studio"><span>البريد الإلكتروني</span><b>hello@glloria.studio</b></a><a href="https://www.instagram.com/glloriaaa" target="_blank" rel="noreferrer"><span><Instagram size={15} /> Instagram</span><b>@glloriaaa</b></a></div></div>
