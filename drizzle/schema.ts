...
export const projects = mysqlTable("projects", {
  ...
  imageKind: varchar("imageKind", { length: 120 }),
  ...
  caseStudyApproved: boolean("caseStudyApproved").default(false).notNull(),
...
export const consultationRequests = mysqlTable("consultation_requests", {
  ...
  description: text("description").notNull(),
  aestheticPreference: text("aestheticPreference"),
  sourceProjectSlug: varchar("sourceProjectSlug", { length: 160 }),
  sourceProjectTitle: varchar("sourceProjectTitle", { length: 255 }),
